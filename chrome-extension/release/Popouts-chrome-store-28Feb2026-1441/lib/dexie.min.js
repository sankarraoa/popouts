...
(function() {
  ...
  class Dexie {
    ...
    /**
     * Dexie-compatible transaction API.
     * Accepts: transaction(mode, store1, store2, ..., callback)
     * Runs the callback after ensureReady. Each store operation uses its own IDB transaction.
     */
    async transaction(mode, ...args) {
      const callback = args[args.length - 1];
      if (typeof callback !== 'function') {
        throw new Error('Last argument to transaction() must be a callback function');
      }
